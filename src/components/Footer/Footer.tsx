...
export default function Footer() {
	return (
		<footer className='bg-white/80 backdrop-blur-md border-t border-slate-900 py-12 mt-16'>
					...
					<div className='text-center md:text-right'>
						...
						<div className='flex justify-center md:justify-end space-x-4'>
							<a
								...
								className='w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 hover:bg-slate-800 hover:text-white transition-all duration-300 transform hover:scale-110'>
							...
							<a
								...
								target='_blank'
								rel='noopener noreferrer'
								className='w-10 h-10 bg-slate-100 rounded-xl flex items-center justify-center text-slate-600 hover:bg-blue-500 hover:text-white transition-all duration-300 transform hover:scale-110'>
